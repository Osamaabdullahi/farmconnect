...
import DashboardOverview from "../../components/groups/DashboardOverview";
import BrowseProducts from "../../components/groups/BrowseProducts";
import OrderHistory from "../../components/groups/OrderHistory";
import Notifications from "../../components/groups/Notifications";
import Profile from "../../components/groups/Profile";
import Settingss from "../../components/groups/Settingss";
import PaymentsInvoices from "../../components/groups/PaymentsInvoices";
import CreateProduceForm from "../../components/CreateProduceForm";
import Navbar from "../../components/Navbar";
import OrderBussiness from "../../components/groups/orderBussiness";
import useFarmConnectStore from "@/store";
import { useRouter } from "next/navigation";
const BusinessDashboard = () => {
  const [activeSection, setActiveSection] = useState("profile");
  const [sidebarOpen, setSidebarOpen] = useState(true);
  const { role, user, isAuthenticated } = useFarmConnectStore();

  const router = useRouter();

  useEffect(() => {
    if (!isAuthenticated) {
      router.push("/sighin"); // Redirect to sign-in page
    }
  ...
  const RenderContentBussiness = () => {
    switch (activeSection) {
      case "orders":
        return <OrderBussiness />;
